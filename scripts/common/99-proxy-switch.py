...
Usage (bash/zsh):
    eval "$(python3 99-proxy-switch.py home)"
    eval "$(python3 99-proxy-switch.py com_inner)"
    eval "$(python3 99-proxy-switch.py com_outer)"
    eval "$(python3 99-proxy-switch.py off)"
"""
